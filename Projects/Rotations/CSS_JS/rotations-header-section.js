...
async function initialize()
{
    ...
    if (projectHeaderTemplate && targetElement)
    {
        ...
        if (projectHeaderSection) {
            ...
            const webglIframeURL = new URL("./rotations-unity-webgl-iframe.html", import.meta.url).href;
            initializeProjectHeaderSection(projectHeaderSection, projectDataURL, webglIframeURL, 'rotations-workflow');
        }
    }
}
